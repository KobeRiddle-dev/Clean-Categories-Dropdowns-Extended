# Basic Dropdowns - Extended

An Extension to Ferny's [Basic Dropdowns](https://steamcommunity.com/sharedfiles/filedetails/?id=3455529827).

Adds a lot more Dropdowns, while still maintaining the objective of not combining so much as to be confusing.

Dropdowns are added for different sizes of the same building, hidden/unhidden versions of conduits, pipes, etc., and variants of the same building (such as IED Traps, Smithies, or Televisions).

Feedback is welcome! I want the groupings to be as intuitive as possible, so if you have suggestions for better groupings, or if you think a grouping should be added or removed, please let me know in the comments.
...
- Skylight, Skylight 2x2, Skylight 3x3, Skylight 1x4 -> Skylights
